...
- ------- Пользователь может выбрать несколько вариантов количество игроков например написать в чат цифру которая будет отвечать за количество (--  1) 2 игрока 2) 4 игрока 3) 8 игроков  --)
- ------- После выбора начинается ожидание игроков и каждому пользователю в чате приходит оповещение о том что турнир создан и присутствует кнопочка присоединиться
- ------- Может быть возможность присоединиться к турниру если пользователь зашел после его создания ( вывод в чат оповещения что турнир присутствует с кнопкой присоединиться )
- ------- Система может ждать заполнения игроков либо сбрасывать этап создания если прошло условных 5-10 минут
- --- 2 этап игры
...
- ------- Противники могут выбираться случайно либо просто четный - нечетный по сути
...
- ------- В чат будет приходить поздравление успешной победы и успешного поражение и к нему будет следовать оповещение о том с кем победитель будет соревноваться следующим
- ------- После последней победы будет супер крутое оповещение о победе в турнире победителю и можно вывести ему в чат его любое достижение ( например забил 20 без единого пропуска шарика и тд)
- --- П С
