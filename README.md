...
- Гугловая авторизация обращается к апи на локалхосте, поэтому попытки зайти через гугл на другом устройстве проваливаются - Константин? или кто-то еще?
- По нажатию кнопки Logoff:
	- игра: удалить данные об игроке, подгрузить нового, все следующие сообщения должны быть с новым ID, ¿послать сообщение на сервер? - Макс
   	- чат: очистить чат, удалить данные о игроке, подгрузить нового, начать весь чат как бы сначала - Анна? или Макс?
- Добить игру:
